...
Changing the active language updates mounted controls without remounting the player. See <DocsLink slug="how-to/internationalize-the-player">Internationalize the player</DocsLink> for complete examples.
...
<DocsLinkCard slug="how-to/internationalize-the-player">Internationalize the player</DocsLinkCard>

<Aside type="tip">
The same guide covers overriding built-in text and providing your own visible component text.
</Aside>
