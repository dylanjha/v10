---
title: 'Controls and User Activity'
...
Use the skin gestures (`tap` with the `toggleControls` action) rather than adding your own tap handlers next to the built-in behavior; competing handlers invert each other. See <DocsLink slug="handbook/keyboard-and-pointer-input">Keyboard and Pointer Input</DocsLink>.
...
- <DocsLink slug="handbook/keyboard-and-pointer-input">Keyboard and Pointer Input</DocsLink>
