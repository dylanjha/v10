...
Quality selection applies to streaming sources. A progressive MP4 has one rendition; HLS and DASH streams offer several. See <DocsLink slug="handbook/sources-and-loading">Sources and Loading</DocsLink>.
