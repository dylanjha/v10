...
Background video autoplays, loops, stays muted, and omits interactive controls. Use `BackgroundVideo` instead of configuring these behaviors yourself: it applies them by default.
