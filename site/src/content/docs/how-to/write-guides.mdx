...
How-to guides also include a few extra frontmatter fields that help search engines and coding agents find the page:
...
- **`keywords`** — search phrases a developer or agent would use to find this page
