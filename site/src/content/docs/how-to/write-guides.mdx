...
A guide may skip a section that doesn't apply, but the sections it has keep these names and this order. One capability per page, with a plain title people search for (Autoplay, not Advanced Playback). One page should fully answer one question for a reader or a coding agent.
