...
Quality selection applies to streaming sources. A progressive MP4 has one rendition; HLS and DASH streams offer several. See <DocsLink slug="how-to/sources-and-loading">Sources and Loading</DocsLink>.
